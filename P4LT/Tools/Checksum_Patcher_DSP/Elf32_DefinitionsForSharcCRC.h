/*-------------------------------------------------------------------------*
 * $Workfile: Elf32_DefinitionsForSharcCRC.h $
 * Part of	:	NSD570 Digital/ ETL600
 * Language	:	C
 * Created by:	Bruno Busslinger NKT2
 * Remarks	:   
 * Purpose	:	Inserting Checksum into firmware on ETL600
 *-------------------------------------------------------------------------*/
                                 
/*-------------------------------------------------------------------------*
 * $Log: /Source/P4LT Prototype 2/Tools/Checksum_Patcher_DSP/Elf32_DefinitionsForSharcCRC.h $ 
 * 
