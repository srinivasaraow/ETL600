 ...
 * FILE        : $Workfile: dec2x12_filt_c.asm $
 * COPYRIGHT   : 2004 by TL Consulting GmbH.
 * DESCRIPTION : 12 tap decimator of complex signal by 2 
 * OPERATION   : 
 * PROTOTYPE   : void Dec2x12_filt_c( complex_float   vOut[], 
 *                                   complex_float    vIn[],             
 *                                   int              nIn,               
 *                                   complex_float pm vCoeffs[12],       
 *                                   complex_float    vDelay[12+1] );    
 *
 * ASSUMPTIONS : all arrays starts with even address and there length is also even
 *               12 coefficients
 *               Size "nIn" of input array "vIn[]" must be even
 *
 * REVISION HISTORY:
 * COMPLEXITY : 
 *-----------------------------------------------------------------------------
