...
//  
// ABSTRACT    Universal SIMD complex radix-2 fast direct Fourier transform 
//             for maximium lenght of 2048 complex samples
//             
//                  
// PREMISES:   
//
...
//
//---------------------------------------------------------------------------
/* $Log: /Source/P4LT Prototype 2/OFDM_DSP/ASM/FFT/fft_c_dpd.asm $
 * 
...
.global _fft32_c_DPD;
.global _fft64_c_DPD;
.global _fft128_c_DPD;
.global _fft256_c_DPD;
.global _fft512_c_DPD;
.global _fft1024_c_DPD;
.global _fft2048_c_DPD;
...
/***************************************************************************
 *
 * Unused registers   VGP
 *
 * i5(saved, but not used), i6, i7
 * m3, m4, m5, m6, m7, 
 * i14, i15
 * m14(saved, but not used), m15
 *
****************************************************************************/
...
/*
 * int fftXXX_c_DPD( float dm         outR[],     <-- refft
 *                   float pm         outI[],     <-- imfft
 ...
 */
      ...
      r2  = 2;
      r3  = -BFLY8;          /*initializes m0,10 - incr for butter branches   */
