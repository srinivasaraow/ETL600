/*-------------------------------------------------------------------------*
 * $Workfile: Interrupt_table_NSD_DSP.asm $
 * Part of      : ETL600 / P4LT
 * Language     : asm
 ...
 *-------------------------------------------------------------------------*/
/*-------------------------------------------------------------------------*
 $Log: /Source/P4LT Prototype 2/NSD_DSP/ASM/Interrupt_table_NSD_DSP.asm $
 * 
 * 2     9.05.05 13:20 Chbrbus
 * MemoryCheck and CRC Patcher initial version added
 * 
 * 1     19.01.05 15:33 Chchlee
 * 
 * 5     11.01.05 13:46 Chharyt
 * Back to version 04.01.2005
 * 
 * 2     4.01.05 15:07 Chbrbus
 * Changed IR routines after walkthrough - not completely tested !!!!!!!
 * 
 * 1     22.07.04 16:06 Buhl01
