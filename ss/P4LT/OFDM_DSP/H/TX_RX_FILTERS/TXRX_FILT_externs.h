 ...
 * REVISION HISTORY:
 *-----------------------------------------------------------------------------
 * $Log: /branches/Source MAS/P4LT/OFDM_DSP/H/TX_RX_FILTERS/TXRX_FILT_externs.h $
 * 
 * 11    24.07.08 15:24 Chhamaa
 * 
 * 6     5.04.06 15:28 Chhamaa
 * 
 * 6     17.03.06 14:41 Chhamaa
 * 
 * 4     13.09.05 13:23 Ats
 * Exchange from TLC
 * 
...
extern complex_float H_fn4_bw4_128_tx[OFDM_N_MAX/4-OFDM_L_MAX/4+1];
extern complex_float H_fn4_bw4_128_rx[OFDM_N_MAX/4-OFDM_L_MAX/4+1];

extern complex_float H_fn4_bw35_128_tx[OFDM_N_MAX/4-OFDM_L_MAX/4+1];
extern complex_float H_fn4_bw35_128_rx[OFDM_N_MAX/4-OFDM_L_MAX/4+1];

extern complex_float H_fn6_bw4_64_tx[OFDM_N_MAX/8-OFDM_L_MAX/8+1];
extern complex_float H_fn6_bw4_64_rx128[128-8+1];

extern complex_float H_fn48_bw4_64_tx[OFDM_N_MAX/8-OFDM_L_MAX/8+1];
extern complex_float H_fn48_bw4_64_rx128[128-8+1];

extern complex_float H_fn6_bw35_64_tx[OFDM_N_MAX/8-OFDM_L_MAX/8+1];
extern complex_float H_fn6_bw35_64_rx128[128-8+1];

extern complex_float H_fn48_bw35_64_tx[OFDM_N_MAX/8-OFDM_L_MAX/8+1];
extern complex_float H_fn48_bw35_64_rx128[128-8+1];

extern complex_float H_fn4_bw35_64_tx[OFDM_N_MAX/8-OFDM_L_MAX/8+1];

extern complex_float H_fn96_bw8_128_tx[128-16+1];
extern complex_float H_fn96_bw8_128_rx[128-16+1];

extern complex_float H_fn96_bw75_128_tx[128-16+1];
extern complex_float H_fn96_bw75_128_rx[128-16+1];

extern complex_float H_fnxx_bwxx_256_tx[256-32+1];
extern complex_float H_fnxx_bwxx_256_rx[256-32+1];

extern complex_float H_fn6_bw6_64_tx[64-8+1];
extern complex_float H_fn6_bw6_64_rx[64-8+1];

extern complex_float H_fn6_bw6_128_tx[128-16+1];
extern complex_float H_fn6_bw6_128_rx[128-16+1];

extern complex_float H_fn6_bw6_256_tx[256-32+1];
extern complex_float H_fn6_bw6_256_rx[256-32+1];

extern complex_float H_fn6_bw6_512_tx[256-32+1];
extern complex_float H_fn6_bw6_512_rx[256-32+1];
