 ...
 *
 * PROJECT     : ETL600  
 * FILE        : $Workfile: TCM_Gen_PCM_Data.c $
 * COPYRIGHT   : 2004 TL Consulting GmbH
 * DESCRIPTION : Generates PCM data vector
 *
 * REVISION HISTORY:
 *-----------------------------------------------------------------------------
 * $Log: /Source/P4LT Prototype 2/OFDM_DSP/C/TCM/TCM_Gen_PCM_Data.c $
 * 
...
void segment ( "seg_ext_pmco" ) TCM_Gen_PCM_Data(unsigned int *OutPCM32, int len, int Mask)
{
