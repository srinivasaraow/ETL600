/*-------------------------------------------------------------------------*
 * $Workfile: Interrupt_table_Master_DSP.asm $
 * Part of      : ETL600 / P4LT
 * Language     : asm
 ...
 *-------------------------------------------------------------------------*/
/*-------------------------------------------------------------------------*
 $Log: /Source/P4LT/Master_DSP/ASM/Interrupt_table_Master_DSP.asm $
 * 
 * 3     19.01.06 17:19 Chmibuh
 * 
 * 2     19.01.06 16:49 Chmibuh
 * _CRC_Checksum_over_all_code = CRC_CHECKSUM_OVER_ALL_CODE
 * 
 * 1     19.01.05 15:47 Chchlee
 * 
 * 7     13.01.05 17:15 Chbrbus
 * DM_InternalProgramStart and DM_InternalProgramStop added
 * 
 * 6     13.01.05 13:44 Chbrbus
 * MagicNumbersForMemoryCheck.h added
 * 
 * 5     12.01.05 11:37 Chbrbus
 * ProgramMemoryCheck added
 * 
 * 4     11.01.05 13:35 Chharyt
 * Back to version 05.01.2005
 * 
 * 3     10.01.05 15:40 Chbrbus
 * different function SPORT02 Rx and Tx IR
 * 
 * 2     5.01.05 15:25 Chbrbus
 * Interrupt routine cleaned
 * 
 * 1     22.07.04 16:02 Buhl01
...
#include "../H/MagicNumbersForMemoryCheck.h"
 ...
 //#define START_ADDR 0x200000		/* base address for an interrupt table in external memory*/

.GLOBAL			___lib_prog_term;	//Termination address
.EXTERN			___lib_setup_c;

.EXTERN			_UartRequest_int;
.EXTERN			_SPR0_int;
.EXTERN			_SPR1_int;
.EXTERN			_timer_int;
.EXTERN			_SPI_DMArx_int;
.EXTERN			_main;
...
.var            _CRC_Checksum_over_all_code = CRC_CHECKSUM_OVER_ALL_CODE;
.global         _CRC_Checksum_over_all_code;
...
___lib_IRQ1I:	RTI;
				...
				NOP;
/* IRQ0 asserted:*/
___lib_IRQ0I:	call _UartRequest_int;	
				RTI;
				NOP;
				NOP;
/* Reserved */	
...
___lib_SPIRI:	call _SPI_DMArx_int;
				RTI;
				NOP;
				NOP;
