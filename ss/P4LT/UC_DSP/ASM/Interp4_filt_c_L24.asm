 ...
 * FILE        : $Workfile: Interp4_filt_c_L24.asm $
 * COPYRIGHT   : 2003 by TL Consulting GmbH.
 * DESCRIPTION : Interpolator of complex signal by 4 
 * OPERATION   : 
 * PROTOTYPE   : void Interp4_filt_c_L24( complex_float    vOut[],         r4
 ...
 *-----------------------------------------------------------------------------
 * 
 * $Log: /Source/P4LT Prototype 2/UC_DSP/ASM/Interp4_filt_c_L24.asm $
 * 
...
.global _Interp4_filt_c_L24;
.global _Interp4_filt_c_L24.end;
