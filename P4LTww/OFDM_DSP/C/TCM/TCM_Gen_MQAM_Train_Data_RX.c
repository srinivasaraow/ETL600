 ...
 *
 * PROJECT     : ETL600  
 * FILE        : $Workfile: TCM_Gen_MQAM_Train_Data_RX.c $
 * COPYRIGHT   : 2004 TL Consulting GmbH
 * DESCRIPTION : Generates PCM data vector
 *
 * REVISION HISTORY:
 *-----------------------------------------------------------------------------
 * $Log: /Source/P4LT Prototype 2/OFDM_DSP/C/TCM/TCM_Gen_MQAM_Train_Data_RX.c $
 * 
...
void segment ( "seg_ext_pmco" ) TCM_Gen_MQAM_Train_Data_RX(unsigned int *OutPCM32, int len, int Mask)
{
