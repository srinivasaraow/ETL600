 ...
 * FILE        : $Workfile: Int4x44_filt_c.asm $
 * COPYRIGHT   : 2004 by TL Consulting GmbH.
 * DESCRIPTION : 44 tap Interpolator of complex signal by 4 using 4 polyphase filters
 * OPERATION   : 
 * PROTOTYPE   : void Int4x44_filt_c( complex_float    vOut[],         r4
 *               complex_float    vIn[],             r8
 *               int              nIn,               r12
 *               complex_float pm vCoeffs[4*11],       reads( 1 )
 ...
 *-----------------------------------------------------------------------------
 *
 * $Log: /Source/P4LT Prototype 2/UC_DSP/ASM/Int4x44_filt_c.asm $
 * 
 * 1     20.01.05 8:32 Chchlee
 * 
 * 1     12.07.04 17:23 Maag01
 * 
 * 1     23-06-04  VGP
 * Initial version
 * 
...
// Delay line
      ...
      r0 = 22;              /* Delay line length in real samples*/
      r1 = dm(23,i0);
// restore i0
...
// Filter coefficients 
      ...
      r0 = 22;              /* Number of subfilter coefficients in real samples*/
      r1 = r1 + r0;         
...
// f15 - output sample of filt #3
      ...
      lcntr = r2, do fir until lce; /* loop per sample */
		 ...
		 f8 = f0*f4, f4 = pm(i9,m8);
		 f8 = f0*f4, f12 = f8+f12, f4 = pm(i10,m8);
		 f8 = f0*f4, f13 = f8+f13, f4 = pm(i11,m8);
		 f8 = f0*f4, f14 = f8+f14;

		 // delays 2-9
         lcntr = 8, do fir1 until lce; //delays 2-6
		   f15 = f8+f15, f0 = dm(i0,m2), f4 = pm(i8,m8);
		   f8 = f0*f4, f4 = pm(i9,m8);
		   f8 = f0*f4, f12 = f8+f12, f4 = pm(i10,m8);
		   f8 = f0*f4, f13 = f8+f13, f4 = pm(i11,m8);
fir1:	   f8 = f0*f4, f14 = f8+f14;

         // delay 10
		 f15 = f8+f15, f0 = dm(i0,m5), f4 = pm(i8,m8);
		 f8 = f0*f4, f4 = pm(i9,m8);
		 f8 = f0*f4, f12 = f8+f12, f4 = pm(i10,m8);
		 f8 = f0*f4, f13 = f8+f13, f4 = pm(i11,m8);
	     f8 = f0*f4, f14 = f8+f14;
         ...
         // delay 0
         f15 = f8 + f15, f0 = dm(i2, m2), f4 = pm(i8,m8);   // f0 - read sample, coef filt #0
		 f12 = f0*f4, dm(i1,m2) = f12, f4 = pm(i9,m8);      // f4 coef filt #1
		 f13 = f0*f4, dm(i1,m2) = f13, f4 = pm(i10,m8);     // f4 coef filt #2
		 f14 = f0*f4, dm(i1,m2) = f14, f4 = pm(i11,m8);     // f4 coef filt #3
		 f15 = f0*f4, dm(i1,m2) = f15;
fir:     dm(i0,m2) = f0;
	  ...
	  // delays 2-9
      lcntr = 8, do fir2 until lce; //delays 2-6
		f15 = f8+f15, f0 = dm(i0,m2), f4 = pm(i8,m8);
		f8 = f0*f4, f4 = pm(i9,m8);
		f8 = f0*f4, f12 = f8+f12, f4 = pm(i10,m8);
		f8 = f0*f4, f13 = f8+f13, f4 = pm(i11,m8);
fir2:	f8 = f0*f4, f14 = f8+f14;
      ...
      // store last 4 samples
      f15 = f8 + f15,  dm(i1,m2) = f12;
	  dm(i1,m2) = f13;
	  dm(i1,m2) = f14;
	  dm(i1,m2) = f15;
