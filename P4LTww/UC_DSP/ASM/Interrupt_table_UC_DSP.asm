/*-------------------------------------------------------------------------*
 * $Workfile: Interrupt_table_UC_DSP.asm $
 * Part of      : ETL600 / P4LT
 * Language     : asm
 ...
 *-------------------------------------------------------------------------*/
/*-------------------------------------------------------------------------*
 $Log: /Source/P4LT Prototype 2/UC_DSP/ASM/Interrupt_table_UC_DSP.asm $
 * 
 * 2     9.05.05 14:35 Chbrbus
 * DSP CRC Patcher added
 * 
 * 1     20.01.05 8:32 Chchlee
 * 
 * 1     22.07.04 16:11 Buhl01
